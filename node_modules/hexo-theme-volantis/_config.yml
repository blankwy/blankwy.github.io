...
cover:
  ...
  features:
    ...
    - name: 源码
      ...
      url: https://github.com/blankwy/blankwy.github.io/
############################### Cover ############################### > end
...
article:
  ...
  body:
    # 文章顶部信息
    # 从 meta_library 中取
    top_meta: counter [author, category, date, counter] #启用评论数量需在此添加
    # ----------------
    # 文章页脚组件
    footer_widget:
      # ----------------
      ...
      # 打赏组件 (for layout: post)
        ...
        enable: false
        images:
          - https://cdn.jsdelivr.net/gh/blankwy/blankwy.github.io@main/qq.png
          - https://cdn.jsdelivr.net/gh/blankwy/blankwy.github.io@main/weixin.png # https://cdn.jsdelivr.net/gh/volantis-x/cdn-org/blog/qrcode/github@volantis.png

###### > - 1. - - 
       
    # 文章底部信息
    # 从 meta_library 中取
    bottom_meta: tags [updated, tags, share]
    # meta library
    meta_library:
      # 默认文章作者（可在 _data/author.yaml 中增加其他作者，并在 front-matter 中设置）
      # https://volantis.js.org/advanced-settings/#多人协同
      author:
        avatar: http://q2.qlogo.cn/headimg_dl?dst_uin=2035650646&spec=100 # https://cdn.jsdelivr.net/gh/volantis-x/cdn-org/blog/favicon/apple-touch-icon.png
        name: Blank
        url: /
      # 文章创建日期
      date:
    ...
    blogger:
      ...
      social:
        ...
        - icon: fas fa-envelope
          url: mailto:2035650646@qq.com
        - icon: fab fa-github
          url: https://github.com/blankwy/
...
site_footer:
  ...
  # site copyright
  copyright: '[Copyright © 2017-2022  Blank](/)'
